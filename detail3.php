    ...
    <div class="card">
      ...
      <div class="product-imgs">
        <div class="img-display">
          <div class="img-showcase">
            <img src="./Admin/img_product/<?php echo $row['p_img']; ?>" alt="shoe image"><!--ขนาดรูปภาพ 640*640 photoshop -->
      ...
      <div class="product-content">
        ...
        <div class="product-price">
          <!-- <p class="new-price " ><span><b style="font-family: 'Prompt', sans-serif;">ราคา 1,550 ~ 2,300  บาท </b></span></p> -->

          <!-- <?php echo number_format($row['p_price'], 2); ?> -->

        </div>
        <div class="product-detail" >
          <h4><b style="font-family: 'Prompt', sans-serif;">รายละเอียดห้องพัก:</b> </h4>
        ...
        <div class="purchase-info">
          ...
          <button type="button" class="btn" style="font-family: 'Prompt', sans-serif;" target="_blank">
            จองห้องพัก <i class="fas fa-shopping-cart"></i>
          </button>
          </a>
        </div>
    ...
    <div class="row">
      <div class="col">
        ...
        <form action="comment_save.php" method="post" class="from-horizontal">
          ...
          <br>
          <button type="submit" class="btn btn-primary" style="font-family: 'Prompt', sans-serif;"> แสดงความคิดเห็น <i class="fal fa-comment-alt-dots "></i></button>
        </form>
      </div>
    </div>
    <br>
...
include('comment_list.php');
  ...
  <footer class="card text-center py-2 text-white  bg-alpha" style="background: #6FBE8C; ">
    <br>
  </footer>
