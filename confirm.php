  ...
  <nav id="navbar" class="navbar navbar-expand-lg  navbar-dark bg-alpha">
    <div class="container-fluid">
      <a class="navbar-brand" href="index.php">
        <img src="images/rk1.png" alt="" width="40" height="40">
  ...
  <section class="container">
    <div class="row">
      <div class="col-12 col-sm-12 col-md-12">
        <h3 class=" py-2 text-center text-primary"><i class="far fa-handshake"> <b style="font-family: 'Prompt', sans-serif;">ยืนยันการสั่งซื้อ</b></i></h3>
        ...
        <div style='overflow-x:auto;'>
          <table class="table table-hover  ">
            ...
            <tr class="bg-alpha text-white">
              ...
              <th width="10%">รูปห้องพัก</th>
              <th width="50%">ห้องพัก</th>
        ...
        <div class="card bg-alpha text-white">
          <h4 class="text-center">รายละเอียดในการสั่งซื้อ</h4>
          <div class="card-body">
            ...
            <form id="formUpdate" method="POST" action="saveorder.php">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  <label for="address" class="text-white">วัน/เดือน/ปี ที่เข้าพัก :</label>
              ...
              <div class="d-grid gap-2">
                <input type="hidden" name="m_id" value="<?php echo $m_id; ?>">
                <input type="hidden" name="total" value="<?php echo $total; ?>">
                <input type="submit" name="submit" class="btn btn-primary" value="ยืนยันการจอง">
              </div>
            </form>
          </div>
        </div> <!-- สิ้นสุด-->
